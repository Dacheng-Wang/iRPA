...
client = OpenAI(
    ...
    api_key="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",
)
...
You always start on DuckDuckGo; you should submit a search query to Google that will take you to the best page for
...
if __name__ == "__main__":
    ...
    def get_gpt_command(objective, url, previous_command, browser_content):
        ...
        response = client.completions.create(model="liquid/lfm-40b:free", prompt=prompt)
    ...
    print("\nWelcome to iRPA! What is your objective?")
    i = input()
    if len(i) > 0:
        objective = i
